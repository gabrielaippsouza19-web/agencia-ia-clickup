...
O GitHub distribui os arquivos do processo. Cada usuário precisa autorizar o ClickUp na própria conta/ambiente. A skill não concede acesso que o conector não tenha e não deve copiar tokens ou credenciais para este repositório.
